...
namespace TriangleNet
{
    ...
    public class Mesh : IMesh
    {
        ...
        {
            // UnityEngine.Debug.Log("INSERT SUBSETG (tri) " + tri);
            // UnityEngine.Debug.Log("INSERT SUBSETG (tri.Org) " + tri.Org());
            // UnityEngine.Debug.Log("INSERT SUBSETG (subsegmark)" + subsegmark);
